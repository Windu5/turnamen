    ...
    <div className="relative z-20 print:hidden mb-4">
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 text-xs sm:text-sm">
          ...
          <div className="flex items-center justify-between md:justify-end w-full md:w-auto md:order-3">
          ...
          <div className={\`\${isMobileMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row items-start md:items-center gap-3 w-full md:w-auto md:order-1\`}>
...
fs.writeFileSync('src/components/BracketToolbar.tsx', code);
